        ...
        >
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Box>
              ...
              >
                Creating unforgettable celebrations with elegant,
                creative and beautifully crafted decorations for every
                ...
                {socialIcons.map((item, index) => (
                  <IconButton
                    ...
                    sx={{
                      ...
                      border:
                        "1px solid rgba(213,164,65,0.5)",

                      bgcolor:
                        "rgba(213,164,65,0.06)",
