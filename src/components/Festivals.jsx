...
const features = [
  {
    ...
    description:
      "Personalized themes based on your festival and style.",
    icon: <AutoAwesomeIcon />,
  },
  {
    title: "Premium Quality",
    description:
      "We use high-quality flowers, fabrics & decorative items.",
    icon: <WorkspacePremiumOutlinedIcon />,
  },
  {
    title: "Timely Setup",
    description:
      "On-time decoration for a stress-free event.",
    icon: <AccessTimeOutlinedIcon />,
  },
  {
    title: "Affordable Packages",
    description:
      "Beautiful decor that fits your budget perfectly.",
    ...
    >
        ...
        >
          ...
          <Typography
            sx={{
              ...
              fontFamily:
                '"Great Vibes", "Alex Brush", "Georgia", cursive, serif',
      ...
      <Box
        sx={{
          ...
          background:
            "linear-gradient(135deg, #fffdf8, #fff8eb)",
        }}
      >
        {/* Section Heading */}
        <Box
...
================================= */}
          ...
          >
            {/* CSS GRID - exact 4 per row like the reference image */}
            <Box
              sx={{
                px: { xs: 2, sm: 3, md: 4 },
                display: "grid",
